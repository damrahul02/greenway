        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="relative pt-32 pb-24 overflow-hidden">
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 left-1/3 w-96 h-96 bg-green-500/6 rounded-full blur-3xl" />
                    <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-blue-500/5 rounded-full blur-3xl" />
                </div>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                        <span className="inline-block text-green-400 font-semibold text-sm uppercase tracking-wider mb-4">Our Memories</span>
                        <h1 className="text-5xl md:text-7xl font-bold mb-6">
                            Photo <span className="gradient-text">Gallery</span>
                        </h1>
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            A visual journey through campus life, events, and student achievements at Greenway Academy.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-2xl mx-auto px-4 text-center">
                    <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}
                        ...
                        <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                            We're curating our best moments. The gallery will be live very soon — check back shortly!
                        </p>
